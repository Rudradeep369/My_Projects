...
print("<form action='UPDATEPRODUCT2.py' method='get' autocomplete='off''>")
...
print("</label></th>")
print("<th><input type='number' min='0' id='pid' PID='pid' placeholder='Product Id...' name='pid' required><br><br></th>")
...
print("<th> <input type='text' id='pname' name='pname' placeholder='Product Name...' name='pname' required><br><br></th>")
